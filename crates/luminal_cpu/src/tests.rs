...
proptest! {
    ...
    #[test]
    fn cpu_add_test(len in 1usize..32, values in proptest::collection::vec(-5.0f32..5.0, 1..64)) {
    ...
    #[test]
    fn cpu_mul_test(len in 1usize..32, values in proptest::collection::vec(0.1f32..5.0, 1..64)) {
        prop_assume!(values.len() >= len);
    ...
    /// Test exp2: 2^x
    #[test]
    fn cpu_exp2_test(len in 1usize..32, values in proptest::collection::vec(-3.0f32..3.0, 1..64)) {
        prop_assume!(values.len() >= len);
